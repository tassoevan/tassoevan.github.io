...
<img
  src='/posts/images/distribuicao-colaboradores.png'
  alt='Diagrama de distribuição dos colaboradores entre setores'
/>
...
<img src='/posts/images/setor-ti.png' alt='Esquema simplificado do setor' />
